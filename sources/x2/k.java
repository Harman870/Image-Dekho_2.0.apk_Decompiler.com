...
public final class k implements e {
    ...
    public final HashMap f12942c = new HashMap();
    ...
    public static class a {
        ...
        /* renamed from: b  reason: collision with root package name */
        public Map<String, String> f12944b = null;
        ...
        public final x2.d a(java.lang.String r15) {
            /*
                r14 = this;
                java.lang.String r0 = "Could not instantiate %s"
                java.lang.String r1 = "Could not instantiate %s."
                java.util.Map<java.lang.String, java.lang.String> r2 = r14.f12944b
                r3 = 0
                java.lang.String r4 = "BackendRegistry"
                r5 = 0
                if (r2 != 0) goto L_0x0093
                android.content.Context r2 = r14.f12943a
            ...
            L_0x009e:
                ...
                java.lang.Class<x2.d> r7 = x2.d.class
                ...
                x2.d r6 = (x2.d) r6     // Catch:{ ClassNotFoundException -> 0x00e3, IllegalAccessException -> 0x00d9, InstantiationException -> 0x00cf, NoSuchMethodException -> 0x00c2, InvocationTargetException -> 0x00b8 }
                return r6
            L_0x00b8:
                r1 = move-exception
            ...
            L_0x00f1:
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: x2.k.a.a(java.lang.String):x2.d");
        }
    }
    ...
    public final synchronized m a(String str) {
        if (this.f12942c.containsKey(str)) {
            return (m) this.f12942c.get(str);
        }
        d a10 = this.f12940a.a(str);
        if (a10 == null) {
            return null;
        }
        i iVar = this.f12941b;
        m create = a10.create(new c(iVar.f12934a, iVar.f12935b, iVar.f12936c, str));
        this.f12942c.put(str, create);
        return create;
    }
}
