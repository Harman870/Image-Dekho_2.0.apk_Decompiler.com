...
public class AlertDialogLayout extends s0 {
    ...
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L_0x0050:
            ...
            androidx.appcompat.widget.s0$a r6 = (androidx.appcompat.widget.s0.a) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L_0x0073
            r7 = r2
        L_0x0073:
            java.util.WeakHashMap<android.view.View, h0.l0> r8 = h0.y.f6776a
            int r8 = h0.y.e.d(r9)
                ...
                if (mode2 != 1073741824) {
                    ...
                    for (int i23 = 0; i23 < childCount; i23++) {
                        ...
                        if (childAt3.getVisibility() != 8) {
                            s0.a aVar = (s0.a) childAt3.getLayoutParams();
                            if (aVar.width == -1) {
                                int i24 = aVar.height;
