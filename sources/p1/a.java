...
public final class a implements d<InputStream> {
    ...
    public InputStream f10646c;

    /* renamed from: p1.a$a  reason: collision with other inner class name */
    public static class C0124a implements b {

        /* renamed from: b  reason: collision with root package name */
        public static final String[] f10647b = {"_data"};

        /* renamed from: a  reason: collision with root package name */
        public final ContentResolver f10648a;

        public C0124a(ContentResolver contentResolver) {
            this.f10648a = contentResolver;
        }

        public final Cursor a(Uri uri) {
            String lastPathSegment = uri.getLastPathSegment();
            return this.f10648a.query(MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, f10647b, "kind = 1 AND image_id = ?", new String[]{lastPathSegment}, (String) null);
        }
    }
    ...
    public static class b implements b {
        ...
        /* renamed from: b  reason: collision with root package name */
        public static final String[] f10649b = {"_data"};

        /* renamed from: a  reason: collision with root package name */
        public final ContentResolver f10650a;
        ...
        public final Cursor a(Uri uri) {
            String lastPathSegment = uri.getLastPathSegment();
            return this.f10650a.query(MediaStore.Video.Thumbnails.EXTERNAL_CONTENT_URI, f10649b, "kind = 1 AND video_id = ?", new String[]{lastPathSegment}, (String) null);
        }
    }
    ...
    public static a c(Context context, Uri uri, b bVar) {
        return new a(uri, new c(com.bumptech.glide.b.b(context).f2548c.a().d(), bVar, com.bumptech.glide.b.b(context).f2549d, context.getContentResolver()));
    }
    ...
    public final void b() {
        InputStream inputStream = this.f10646c;
        if (inputStream != null) {
            try {
                inputStream.close();
    ...
    public final java.io.InputStream d() {
        /*
            ...
            p1.c r1 = r11.f10645b
            android.net.Uri r2 = r11.f10644a
            r1.getClass()
            r3 = 0
            r4 = 3
            r5 = 0
            p1.b r6 = r1.f10651a     // Catch:{ SecurityException -> 0x002e, all -> 0x002b }
        ...
        L_0x0072:
            ...
            android.content.ContentResolver r1 = r1.f10653c     // Catch:{ NullPointerException -> 0x00cf }
            java.io.InputStream r1 = r1.openInputStream(r3)     // Catch:{ NullPointerException -> 0x00cf }
        L_0x007c:
            r2 = -1
            if (r1 == 0) goto L_0x00c5
            p1.c r3 = r11.f10645b
            android.net.Uri r6 = r11.f10644a
            r3.getClass()
            android.content.ContentResolver r7 = r3.f10653c     // Catch:{ IOException -> 0x009e, NullPointerException -> 0x009c }
            java.io.InputStream r5 = r7.openInputStream(r6)     // Catch:{ IOException -> 0x009e, NullPointerException -> 0x009c }
            java.util.List<com.bumptech.glide.load.ImageHeaderParser> r7 = r3.f10654d     // Catch:{ IOException -> 0x009e, NullPointerException -> 0x009c }
            r1.b r3 = r3.f10652b     // Catch:{ IOException -> 0x009e, NullPointerException -> 0x009c }
            int r0 = com.bumptech.glide.load.a.a(r3, r5, r7)     // Catch:{ IOException -> 0x009e, NullPointerException -> 0x009c }
        ...
        L_0x00fa:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p1.a.d():java.io.InputStream");
    }
