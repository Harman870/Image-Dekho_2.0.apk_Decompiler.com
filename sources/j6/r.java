...
public final class r<T> implements a<Set<T>> {
    ...
    public volatile Set<a<T>> f8761a = Collections.newSetFromMap(new ConcurrentHashMap());

    /* renamed from: b  reason: collision with root package name */
    public volatile Set<T> f8762b = null;

    public r(Collection<a<T>> collection) {
        this.f8761a.addAll(collection);
    }
    ...
    public final java.lang.Object get() {
        /*
            r3 = this;
            java.util.Set<T> r0 = r3.f8762b
            if (r0 != 0) goto L_0x003e
            monitor-enter(r3)
            java.util.Set<T> r0 = r3.f8762b     // Catch:{ all -> 0x003b }
            ...
            r3.f8762b = r0     // Catch:{ all -> 0x003b }
            monitor-enter(r3)     // Catch:{ all -> 0x003b }
            java.util.Set<u6.a<T>> r0 = r3.f8761a     // Catch:{ all -> 0x0036 }
        ...
        L_0x001b:
            ...
            u6.a r1 = (u6.a) r1     // Catch:{ all -> 0x0036 }
            java.util.Set<T> r2 = r3.f8762b     // Catch:{ all -> 0x0036 }
            java.lang.Object r1 = r1.get()     // Catch:{ all -> 0x0036 }
            r2.add(r1)     // Catch:{ all -> 0x0036 }
            goto L_0x001b
        L_0x0031:
            r0 = 0
            r3.f8761a = r0     // Catch:{ all -> 0x0036 }
        ...
        L_0x003e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: j6.r.get():java.lang.Object");
    }
}
