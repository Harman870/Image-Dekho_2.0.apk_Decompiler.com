...
public final class b {
    ...
    public static class C0120b<T> implements Comparator<T> {

        /* renamed from: a  reason: collision with root package name */
        public final Rect f10474a = new Rect();

        /* renamed from: b  reason: collision with root package name */
        public final Rect f10475b = new Rect();

        /* renamed from: c  reason: collision with root package name */
        public final boolean f10476c;

        /* renamed from: d  reason: collision with root package name */
        public final a<T> f10477d;

        public C0120b(boolean z9, a.C0119a aVar) {
            this.f10476c = z9;
            this.f10477d = aVar;
        }

        public final int compare(T t10, T t11) {
            Rect rect = this.f10474a;
            Rect rect2 = this.f10475b;
            ((a.C0119a) this.f10477d).getClass();
            ((f) t10).d(rect);
            ((a.C0119a) this.f10477d).getClass();
            ((f) t11).d(rect2);
            int i10 = rect.top;
