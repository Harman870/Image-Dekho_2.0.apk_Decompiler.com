...
public final class d {
    ...
    public final void a() {
        /*
            r2 = this;
            monitor-enter(r2)
            boolean r0 = r2.f6028a     // Catch:{ all -> 0x002d }
            if (r0 == 0) goto L_0x0007
            monitor-exit(r2)     // Catch:{ all -> 0x002d }
            return
        L_0x0007:
            r0 = 1
            r2.f6028a = r0     // Catch:{ all -> 0x002d }
            r2.f6030c = r0     // Catch:{ all -> 0x002d }
            d0.d$a r0 = r2.f6029b     // Catch:{ all -> 0x002d }
            monitor-exit(r2)     // Catch:{ all -> 0x002d }
            r1 = 0
        ...
        L_0x002d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: d0.d.a():void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void b(d0.d.a r2) {
        /*
            r1 = this;
            monitor-enter(r1)
        L_0x0001:
            boolean r0 = r1.f6030c     // Catch:{ all -> 0x001c }
            if (r0 == 0) goto L_0x0009
            r1.wait()     // Catch:{ InterruptedException -> 0x0001 }
            goto L_0x0001
        L_0x0009:
            d0.d$a r0 = r1.f6029b     // Catch:{ all -> 0x001c }
            if (r0 != r2) goto L_0x000f
            monitor-exit(r1)     // Catch:{ all -> 0x001c }
            return
        L_0x000f:
            r1.f6029b = r2     // Catch:{ all -> 0x001c }
            boolean r0 = r1.f6028a     // Catch:{ all -> 0x001c }
        ...
        L_0x001c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: d0.d.b(d0.d$a):void");
    }
}
