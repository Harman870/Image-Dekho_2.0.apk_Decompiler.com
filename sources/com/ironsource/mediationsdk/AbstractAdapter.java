...
public abstract class AbstractAdapter implements NativeAdAdapterInterface, BannerAdapterInterface, InterstitialAdapterInterface, RewardedVideoAdapterInterface {
    ...
    public void initBannerForBidding(String str, String str2, JSONObject jSONObject, BannerSmashListener bannerSmashListener) {
        ...
        if (bannerAdapter != null) {
            ...
            bannerSmashListener.onBannerInitFailed(new IronSourceError(IronSourceError.ERROR_CODE_GENERIC, "method not implemented"));
        }
    }
    ...
    public void initInterstitial(String str, String str2, JSONObject jSONObject, InterstitialSmashListener interstitialSmashListener) {
        ...
        if (interstitialAdapter != null) {
            ...
            interstitialSmashListener.onInterstitialInitFailed(new IronSourceError(IronSourceError.ERROR_CODE_GENERIC, "method not implemented"));
        }
    }
