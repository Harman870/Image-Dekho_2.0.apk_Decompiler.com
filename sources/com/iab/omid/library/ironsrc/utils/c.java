...
public class c {
    ...
    private static WindowManager f3586a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f3587b = {"x", "y", "width", "height"};

    /* renamed from: c  reason: collision with root package name */
    public static float f3588c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f3586a != null) {
            ...
            f3586a.getDefaultDisplay().getRealSize(point);
            f11 = a(point.x);
            f10 = a(point.y);
        } else {
            f10 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f3588c = context.getResources().getDisplayMetrics().density;
            f3586a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0035a aVar) {
        e a10 = aVar.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f3589a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put("width", (double) a10.f3590a);
            jSONObject.put("height", (double) a10.f3591b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
